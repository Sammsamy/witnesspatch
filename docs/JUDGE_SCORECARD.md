...
- [x] Pass pre-publication checkpoint `d17d075` through the complete release verifier from fresh macOS and local Debian clones, including `131/131` core tests on macOS, `130/131` pass plus one expected filesystem skip on Debian, `6/6` rendered checks, `1/1` HTTP smoke, `6/6` submission checks, and a 59-asset Wrangler dry run; confirm byte-identical physical 55-file `dist/client` snapshots with canonical manifest SHA-256 `1133339d1b372491084a06f889acd97399f2de2988d6267eb13baa48dd4b3721`.
