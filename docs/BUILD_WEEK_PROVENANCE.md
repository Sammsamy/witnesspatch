...
- The first dated post-start Git commit is still pending. Once created, history must not be rewritten in a way that obscures the before/after record.
