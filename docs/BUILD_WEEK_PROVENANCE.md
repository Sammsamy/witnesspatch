...
- Release-code checkpoint `9f2cd8da2ea03f294a247cb91795571e744a68fb` passed `npm ci` followed by the full expanded release verifier from a fresh local clone on macOS with Node 24.14.0, including the first-page and retained-manifest HTTP smoke. Checkpoints `15f1aee67b419822cab54310ae9bec7cd321cb9c` and `a056fe337208c0f377918bb8502d2bc6324ba19a` preserve the earlier release and cross-runtime evidence. See `docs/CLEAN_CHECKOUT_RECEIPT.md`; an exact submitted-commit replay after final freeze, Linux, Windows, public CI, and independent external reproduction remain outstanding.
