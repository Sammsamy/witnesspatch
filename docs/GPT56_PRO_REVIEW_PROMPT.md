...
- `94/94` engine tests and `5/5` rendered-product tests pass locally. Lint, typecheck, production static build, prior clean Node 22.15 and Node 24.14 runs, locked-license fingerprint verification, and dependency audit have passed. Recheck the attached latest transcript; test source alone is not proof of a passing command.
